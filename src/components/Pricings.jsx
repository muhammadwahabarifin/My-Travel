        ...
        <>
            <div className='my-16 relative'>
              <div className="travigo-container">
                <div className='grid items-center justify-items-center mb-11 md:mb-7 text-center'>
                    <h1 className='text-5xl lg:text-4xl md:text-3xl sm:text-2xl xsm:text-xl font-bold filter drop-shadow-lg text-slate-800'>
                        {title}
                    </h1>
                    ...
                    <div className='ring-1 ring-slate-100 rounded-full py-1.5 px-2 flex items-center justify-between gap-5 my-5 shadow-md shadow-slate-200'>
                        <button type='button' className='btn-emrald sm:w-auto'>{btn1}</button>
